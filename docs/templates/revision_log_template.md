...
skill_used: SKILL_[JOURNAL]_[DATE].md
revision_date: [DATE]
...
**Rules applied:**
- Rule 1: [rule name] — Source: [journal-card (STRONG) / journal-card (WEAK) / econ-base / logic-fix]
- Rule 2: [rule name] — Source: [...]

**Conflict resolved?** [yes / no]
- If yes: [describe which rule won and why, e.g., "Journal preference for embedded contribution (STRONG) overrode general econ rule for numbered list"]
...
- **Target skill:** [this-journal-only / journal-adaptive-general / econ-base-candidate]
